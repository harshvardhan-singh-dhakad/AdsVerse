...
const ContactForm = dynamic(
  ...
  { ssr: false, loading: () => <div className="min-h-[300px] flex items-center justify-center text-sm text-muted-foreground">Loading form...</div> }
);
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4 font-headline text-violet-400">Follow Us</h2>
              <Button asChild variant="outline" size="icon">
                <Link href={brand.instagramUrl} aria-label="Instagram" target="_blank" rel="noopener noreferrer nofollow">
              ...
              <Button asChild variant="outline" size="icon">
                <Link href={brand.facebookUrl} aria-label="Facebook" target="_blank" rel="noopener noreferrer nofollow">
              ...
              <Button asChild variant="outline" size="icon">
                <Link href={brand.xUrl} aria-label="X" target="_blank" rel="noopener noreferrer nofollow">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6 text-muted-foreground hover:text-primary">
              ...
              <Button asChild variant="outline" size="icon">
                <Link href={brand.linkedinUrl} aria-label="LinkedIn" target="_blank" rel="noopener noreferrer nofollow">
