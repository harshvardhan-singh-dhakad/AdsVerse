...
const timelineEvents = [
  { year: "2018", title: "The Spark", description: "SynergyFlow Digital was founded with a mission to demystify digital marketing for growing businesses." },
  ...
  return (
    <div className="container mx-auto py-16 px-4">
      <section className="text-center mb-24">
        <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight">About SynergyFlow</h1>
