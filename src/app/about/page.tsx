  ...
  return (
    ...
    <div className="container mx-auto py-16 px-4">
      ...
      <section className="text-center mb-24">
        <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight font-headline text-slate-950 dark:text-white"><span className="text-violet-600 dark:text-violet-400">About</span> <span className="text-brand-orange">AdsVerse</span></h1>
      ...
      <section className="grid md:grid-cols-2 gap-16 items-center mb-24">
        <div>
          ...
          <p className="text-slate-900 dark:text-slate-300 text-lg">
        ...
        <div className="md:text-right">
          <h2 className="text-3xl font-bold mb-4 text-violet-600 dark:text-violet-400 font-headline">Our Vision</h2>
          <p className="text-slate-900 dark:text-slate-300 text-lg">
        ...
        <Card className="bg-card/50 backdrop-blur-sm overflow-hidden border-primary/20">
          <div className="grid md:grid-cols-3 items-center">
            ...
            <div className="md:col-span-2 p-8 md:p-12">
              ...
              <p className="text-xl font-semibold text-violet-600 dark:text-violet-400 mb-4">Deepak Dhakad — Founder, AdsVerse | Digital Marketing Expert, Indore</p>
      ...
      <section className="mb-24">
        <h2 className="text-4xl font-bold text-center mb-4 font-headline text-slate-950 dark:text-white">Why Businesses Choose <span className="text-brand-orange">AdsVerse</span></h2>
        <p className="text-center text-slate-900 dark:text-slate-300 max-w-2xl mx-auto mb-12">We are not a full-service agency that does everything adequately. We are a specialist performance marketing agency that does a focused set of things exceptionally well.</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {whyChooseUs.map((item) => (
            <Card key={item.title} className="bg-card/50 backdrop-blur-sm border-primary/20 transition-transform duration-300 hover:-translate-y-2">
              ...
              <CardContent>
                <p className="text-slate-800 dark:text-slate-300 text-sm">{item.description}</p>
              </CardContent>
            </Card>
          ))}
        </div>
      ...
      <section className="mb-24">
        <h2 className="text-4xl font-bold text-center mb-4 font-headline text-slate-950 dark:text-white">Our Expertise in <span className="text-brand-orange">SEO, GEO & AEO</span></h2>
        <p className="text-center text-slate-900 dark:text-slate-300 max-w-2xl mx-auto mb-12">Understanding these three disciplines — and how they work together — is the foundation of every growth strategy we build at AdsVerse.</p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            ...
            <CardContent>
              <p className="text-slate-800 dark:text-slate-300 text-sm mb-3">Search Engine Optimisation (SEO) is the practice of improving a website&apos;s visibility in organic (unpaid) search engine results. It encompasses technical website optimisation, high-quality content creation, authoritative link building, and a precise understanding of user search intent.</p>
              <p className="text-slate-800 dark:text-slate-300 text-sm">Effective SEO helps businesses attract consistent, qualified traffic from Google and other search engines — without paying for every click. As a specialist SEO agency in Indore, AdsVerse delivers SEO that connects rankings to revenue.</p>
            </CardContent>
          </Card>
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            <CardHeader>
              <CardTitle className="text-violet-600 dark:text-violet-400 font-headline">What is GEO?</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-slate-800 dark:text-slate-300 text-sm mb-3">Generative Engine Optimisation (GEO) is the practice of optimising a brand&apos;s digital presence to be cited, referenced, and recommended by AI-powered search engines and large language models — including ChatGPT, Google Gemini, Claude, and Perplexity AI.</p>
              <p className="text-slate-800 dark:text-slate-300 text-sm">As more users turn to AI assistants for answers and recommendations, GEO ensures that your business is the source those AI systems cite — making your brand discoverable in a new generation of search behaviour that traditional SEO alone cannot capture.</p>
            </CardContent>
          </Card>
          <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
            <CardHeader>
            ...
            <CardContent>
              <p className="text-slate-800 dark:text-slate-300 text-sm mb-3">Answer Engine Optimisation (AEO) is the discipline of structuring content and website data so that search engines and AI systems can directly extract and display your content as a definitive answer — in Google Featured Snippets, AI Overviews, voice search results, and knowledge panels.</p>
              <p className="text-slate-800 dark:text-slate-300 text-sm">AEO requires concise, authoritative writing, structured data markup (Schema.org), and a content architecture that aligns with how AI systems parse and prioritise information when generating answers for users.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-card/50 backdrop-blur-sm border-primary/20">
          <CardHeader>
            <CardTitle className="text-slate-950 dark:text-white font-headline text-2xl">How AdsVerse Combines All Three</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4 text-slate-900 dark:text-slate-300">
      ...
      <section>
        <h2 className="text-4xl font-bold text-center mb-16 font-headline text-slate-950 dark:text-white">Our <span className="text-brand-orange">Journey</span></h2>
                 ...
                 <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                  <div className={`relative ${index % 2 === 0 ? 'text-right' : 'text-left'}`}>
                    <Card className="bg-card/50 backdrop-blur-sm inline-block text-left">
                        ...
                        <CardContent>
                            <p className="text-slate-800 dark:text-slate-300">{event.description}</p>
                        </CardContent>
                    </Card>
                   </div>
                </div>
