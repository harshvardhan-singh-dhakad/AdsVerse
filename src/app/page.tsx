...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section aria-label="Hero: AI-Powered Digital Marketing Agency in Indore" className="relative w-full pt-16 md:pt-24 pb-8 mb-20 md:mb-[160px] overflow-hidden">
            ...
            <div className="w-full md:w-1/2 space-y-6 md:space-y-10 relative z-10 text-left">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-6 md:gap-8 pt-8 md:pt-10 border-t border-border-glass mt-8 md:mt-10">
                ...
                <div className="border-l border-border-glass pl-2 sm:pl-6 md:pl-8">
                  ...
                  <div className="font-sans text-[10px] sm:text-[15px] font-semibold text-slate-700 dark:text-slate-300">Google Rating</div>
                </div>
              </div>
            </div>
      ...
      <section aria-label="Client Testimonials" className="max-w-[1280px] mx-auto px-5 md:px-8 mb-20 md:mb-[160px]">
          <div className="text-center mb-10">
            ...
            <div className="flex flex-col items-center justify-center gap-2 mt-4">
              <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800/80 px-4 py-1.5 rounded-full shadow-sm">
                ...
                <span className="font-sans text-xs md:text-sm font-semibold text-slate-800 dark:text-slate-200">
          ...
          <ul aria-label="Client Testimonials" className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, index) => {
              ...
              const code = t.name.charCodeAt(0) + (t.name.charCodeAt(t.name.length - 1) || 0);
              ...
              return (
                <li key={index} className="glass-card p-5 sm:p-8 md:p-10 rounded-3xl relative flex flex-col justify-between">
                  ...
                  <div className="flex items-center gap-4 border-t border-border-glass pt-5 md:pt-6">
                    <div className={cn("w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center font-bold text-lg md:text-xl select-none shadow-[0_4px_12px_rgba(0,0,0,0.15)] border border-white/20", avatarBg)}>
                      {t.initials}
                    </div>
                    <div>
                      <div className="font-sans text-base md:text-lg font-bold text-slate-900 dark:text-white leading-tight">{t.name}</div>
                      <div className="flex items-center gap-1 text-emerald-500 my-0.5">
                        <CheckCircle2 className="h-3 w-3 fill-emerald-500/10 shrink-0" aria-hidden="true" />
                        <span className="font-sans text-[10px] md:text-xs font-bold uppercase tracking-wider">Verified Client</span>
                      </div>
                      <div className="font-sans text-xs md:text-[15px] font-medium text-slate-700 dark:text-slate-300 leading-normal">{t.role}</div>
                    </div>
                  </div>
                </li>
              );
