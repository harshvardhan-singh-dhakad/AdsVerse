...
export default function RealEstateCaseStudyPage() {
  ...
  return (
    ...
    <article className="container mx-auto py-16 px-4 max-w-4xl">
      ...
      <Image
        src="https://github.com/harshvardhan-singh-dhakad/image/blob/main/Case%20Study%20How%20an%20Indore%20Real%20Estate%20Project%20Sold%2040%25%20Units%20via%20Digital%20Marketing%20Case%20Study.jpg?raw=true"
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-foreground/90 space-y-6">
        ...
        <p>
            We optimized their Google Business Profile and website for search terms like "3 BHK flats in Super Corridor" and "new projects in Indore." This <Link href="/services/seo-optimization" className="text-accent hover:underline">Local SEO</Link> strategy captured high-intent buyers who were actively searching on Google, bringing in highly qualified organic leads.
        </p>
        ...
        <p>
            This case study proves that for Indore's real estate market, a digital-first approach is no longer an option—it's a necessity. By combining targeted <Link href="/services/paid-ads" className="text-accent hover:underline">paid ads</Link> with powerful <Link href="/services/automation-tools" className="text-accent hover:underline">automation</Link> and foundational <Link href="/services/seo-optimization" className="text-accent hover:underline">SEO</Link>, real estate projects can build a predictable sales engine, reduce costs, and achieve remarkable growth.
        </p>
      </div>
    </article>
    </>
