...
export const metadata: Metadata = {
    ...
    description: "Read the Privacy Policy for AdsVerse. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service.",
};
  ...
  return (
    <div className="container mx-auto py-16 px-4 max-w-4xl">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mx-auto text-foreground/90 space-y-6">
        ...
        <h2 className="text-3xl font-bold text-primary">Information Collection and Use</h2>
        <p>
          We collect several different types of information for various purposes to provide and improve our Service to you.
        </p>
        <h3 className="text-2xl font-semibold text-accent">Types of Data Collected</h3>
        <p>
        ...
        <h2 className="text-3xl font-bold text-primary">Data Sharing and Disclosure</h2>
        <p>
        ...
        <h2 className="text-3xl font-bold text-primary">Data Security</h2>
        <p>
            The security of your data is important to us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.
        </p>

        <h2 className="text-3xl font-bold text-primary">Changes to This Policy</h2>
        <p>
