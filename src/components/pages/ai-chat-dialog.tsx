          ...
          <div className="space-y-4">
            {messages.length === 0 && (
                <div className="text-center text-sm text-muted-foreground p-8">
                    ...
                    <p className="text-xs mt-2">e.g., "Tell me about your SEO services" or "What does the branding package include?"</p>
                </div>
            )}
            {messages.map((message, index) => (
              ...
              >
                ...
                <div
                  className={cn(
                    "p-3 rounded-lg max-w-sm prose dark:prose-invert prose-sm",
                    message.role === "user"
