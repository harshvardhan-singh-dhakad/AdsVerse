...
const socialLinks = [
  ...
  { href: "https://www.instagram.com/adsverse.ai", icon: (
  ...
  { href: "https://www.facebook.com/adsverse.in", icon: (
      ...
      <div className="fixed bottom-6 right-5 z-50">
        <div className="relative flex flex-col-reverse items-center gap-2">
          <Button
            ...
            size="icon"
            className={cn(
              "w-16 h-16 rounded-full bg-orange-500 text-white shadow-lg hover:bg-orange-600 transition-transform duration-300",
               isOpen && "rotate-90"
            )}
          ...
          >
            ...
            <GridDotsIcon className={cn("h-10 w-10 absolute transition-opacity duration-300", isOpen && "opacity-0")} aria-hidden="true" />
          </Button>
