            ...
            <div className="max-w-7xl mx-auto flex flex-wrap items-center gap-4">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    {form.formState.isSubmitting ? <Loader2 className="w-3.5 h-3.5 mr-2 animate-spin" /> : <Calendar className="w-3.5 h-3.5 mr-2" />}
                    {initialData?.status === 'schedule' ? 'Edit Schedule' : 'Schedule'}
                  </Button>
                </PopoverTrigger>
                <PopoverContent className="w-80 p-6 bg-card/95 backdrop-blur-2xl border-border/10 shadow-2xl rounded-2xl z-[150]" align="end" side="top" sideOffset={20}>
                  <div className="space-y-4">
                    <div className="flex items-center gap-2 border-b border-border/10 pb-3 mb-2">
                    ...
                    <FormField control={form.control} name="publishedDate" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription className="text-[10px] leading-relaxed">
                          Choose when this post should go live. Posts will appear automatically on the blog page.
                        </FormDescription>
                      </FormItem>
                    )} />
